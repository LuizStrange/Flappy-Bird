...
function Barreira(reversa = false) {
        this.elemento = NovoElemento('div', 'barreira') // recebe uma div e uma classname barreira
...
function areaSobrepostos(elementoA, elementoB) {
...
function Colidiu(passaro, barreiras) {
    ...
    barreiras.pares.forEach(PardeBarreiras => {
        if(!colidiu) {
            ...
            colidiu = areaSobrepostos(passaro.elemento, superior) || areaSobrepostos(passaro.elemento, inferior)
        }
    })
    return colidiu
}
...
function FlappyBird() {
    ...
    this.start = () => {
        // loop do jogo // existe varias tecnicas para colcoa animações 
